...
sns.pairplot(dfm[dfm['REQUESTED_AMOUNT'] > 100000], vars = ['AGE','VAL_CREDITS_RON'],
             hue = 'PRESCORING', diag_kind = 'hist')
plt.show()
sns.pairplot(dfm[dfm['REQUESTED_AMOUNT'] > 100000], vars = ['AGE', 'VAL_CREDITS_RON', 'REQUESTED_AMOUNT', 'VENIT_PER_YEAR_RON'],
             hue = 'PRESCORING', diag_kind = 'hist')
plt.show()
