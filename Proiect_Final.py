...
# Acelasi lucru folosind matplotlib
plt.figure(figsize=(10, 6))
plt.hist(angajati["Salariu_final"], bins=30, color='skyblue')
plt.title('Distributia Salariilor Finale')
plt.xlabel('Salariu Final')
plt.ylabel('Numar de Angajati')
plt.show()
...
angajati_maria = angajati.loc[(angajati["Prenume"] == "Maria") & (angajati["Salariu_final"] > 10000), ["Nume_prenume", "Nume_Funcție", "Salariu_final"]]
...
statistici_salarii_per_interval = functii_angajati.groupby("Clasificare Salariu Maxim")["Salariu_mediu"].agg(["mean", "median"])
...
print(angajati_functii.to_string())
print("\n")
